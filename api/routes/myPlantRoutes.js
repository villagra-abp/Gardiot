...
function validateInput(data) {
  ...
  if (data.xCoordinate && !validator.isInt(data.xCoordinate)) resp += 'Coordenada X no válida, ';
  if (data.yCoordinate && !validator.isInt(data.yCoordinate)) resp += 'Coordenada Y no válida, ';
  if (data.number && !validator.isInt(data.number)) resp += 'Número no válido, ';
  if (data.plant && !validator.isInt(data.plant)) resp += 'Planta no válida, ';
  if (data.garden && !validator.isInt(data.garden)) resp += 'Jardín no válido, ';
  if (data.soil && !validator.isInt(data.soil)) resp += 'Suelo no válido, ';
  if (data.seed && !validator.isISO8601(data.seed)) resp += 'Fecha no válida, ';
